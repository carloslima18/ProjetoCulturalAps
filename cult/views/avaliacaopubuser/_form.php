...
<div class="avaliacaopubuser-form">
    ...
    <!--?= $form->field($model, 'idpubuser')->textInput() ?-->
    ...
    echo $form->field($model, 'idpubuser')->widget(\kartik\select2\Select2::classname(),								//para os parametros aqui vc tem os mesmo na pagina do kartik "demos.krajee.com/widget-details/selec2
        [
